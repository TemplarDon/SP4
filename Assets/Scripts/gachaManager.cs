...
public class gachaManager : MonoBehaviour {
    ...
    public Text moneyText;
        ...
        PersistentData.m_Instance.firstTimeAtShop = false;
    }
	...
	void Update () {
        ...
        if (playAnim == true)
        {
            ...
            if(frameNum >= 60)
            {
                ...
                string discardedItem = prizeImage.GetComponent<Image>().sprite.name.Replace("helmet_", "").Replace("weapon_", "").Replace("item_", "");
